...
//    #########################################  mapper  ###############################################
    ...
    public static final String MAPPER_CommonPart = "package com.springboot.demo.mapper;\n" +
            "\n" +
            "\n" +
            ...
            "\n" +
            "    @DeleteProvider(type = ENTITYNAMEXXXProvider.class, method = \"delete\")\n" +
            ...
            "    List<ENTITYNAMEXXX> find(HashMap map);\n" +
            "\n" +
...
//    ########################################### Service #################################################
    ...
    static final String Service_common = "package com.springboot.demo.service;\n" +
            "\n" +
            "import com.springboot.demo.entity.ENTITYNAMEXXX;\n" +
            "\n" +
            "import java.util.HashMap;\n" +
            ...
            "    int update(ENTITYNAMEXXX obj);\n" +
            "\n" +
            "    PageInfo<ENTITYNAMEXXX> find(HashMap map);\n" +
            "\n" +
            "    ENTITYNAMEXXX findSingle(Map<String, Object> map);\n" +
            "\n" +
            "}\n";
...
//    ########################### ServiceImpl  #################################
    ...
    static final String ServiceImpl = "package com.springboot.demo.service.impl;\n" +
            "\n" +
            ...
            "\n" +
            "    @Override\n" +
            "    public  PageInfo<ENTITYNAMEXXX> find(HashMap map) {\n" +
            "\n" +
            "        int pageIndex = 0;\n" +
            "        int pageSize = 10;\n" +
    ...
    //    ############################################## Controller ########################################################
    static final String Controller = "package com.springboot.demo.controller;\n" +
            "\n" +
            "import com.github.pagehelper.PageInfo;\n" +
            ...
            "        return JsonResult.buildSuccess(TABLENAME_CDNService.delete(map));\n" +
            "    }\n" +
            "\n" +
            "\n" +
            "    /**\n" +
